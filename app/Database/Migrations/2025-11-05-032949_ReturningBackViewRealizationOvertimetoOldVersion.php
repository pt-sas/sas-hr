...
class ReturningBackViewRealizationOvertimetoOldVersion extends Migration
{
    public function up()
    {
        ...
        CASE 
        WHEN DATE(trx_overtime_detail.startdate) <= DATE(trx_overtime.submissiondate) 
            AND trx_overtime_detail.approve_date IS NOT NULL
