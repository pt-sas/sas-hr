<div class="card-body card-form">
    <form class="form-horizontal" id="form_massleave">
        <?= csrf_field(); ?>
        <div class="row">
            <div class="col-md-3">
            ...
            <div class="col-md-6">
                ...
                <div class="form-check">
                    <label class="form-check-label">
                        <input type="checkbox" class="form-check-input" id="isaffect" name="isaffect">
                        <span class="form-check-sign">Mengikuti</span>
                    </label>
                    <label class="form-check-label">
