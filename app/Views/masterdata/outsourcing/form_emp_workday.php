<form class="form-horizontal" id="form_emp_workday">
    <?= csrf_field(); ?>
    <h4 class="card-title ml-2">Hari Kerja</h4>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="form-group table-responsive">
                <table class="table-rounded table-head-bg-primary table-hover tb_displaytab" id="table-emp-workday" style="width: 100%">
                    <thead>
                        <tr>
                            <th>#</th>
