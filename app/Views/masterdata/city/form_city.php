<div class="card-body card-form">
    <form class="form-horizontal" id="form_city">
        <?= csrf_field(); ?>
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <label for="value">Kode Kota <span class="required">*</span></label>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label for="md_province_id">Provinsi </label>
                    <select class="form-control select-data" id="md_province_id" name="md_province_id"
                        data-url="province/getList">
