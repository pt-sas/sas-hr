    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <select class="form-control select-data" id="md_bloodtype_id" name="md_bloodtype_id" data-url="bloodtype/getList">
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <select class="form-control select-data" id="md_religion_id" name="md_religion_id" data-url="religion/getList">
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <select class="form-control select-data" id="marital_status" name="marital_status" data-url="reference/getList/$MaritalStatus">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <select class="form-control select-data" id="homestatus" name="homestatus" data-url="reference/getList/$HomeStatus">
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label for="superior_id">Superior <span class="required">*</span></label>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control number" id="bpjs_kes_no" name="bpjs_kes_no">
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
