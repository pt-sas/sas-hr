    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <textarea type="text" class="form-control text-uppercase" id="address_dom" name="address_dom" rows="2"
                    <?= $readonly ?>></textarea>
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <textarea type="text" class="form-control text-uppercase" id="address" name="address" rows="2"
                    <?= $readonly ?>></textarea>
