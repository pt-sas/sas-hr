<form class="form-horizontal" id="form_emp_job">
    <?= csrf_field(); ?>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="form-group table-responsive">
                <table class="table-rounded table-head-bg-primary table-hover tb_displaytab" id="table-emp-job" style="width: 100%">
                    <thead>
                        <tr>
                            <th>#</th>
                            ...
                            <th class="text-center">Alasan Berhenti</th>
