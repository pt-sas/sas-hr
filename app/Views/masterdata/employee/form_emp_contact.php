<form class="form-horizontal" id="form_emp_contact">
    <?= csrf_field(); ?>
    <h4 class="card-title ml-2">Kontak Darurat</h4>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="form-group table-responsive">
                <table class="table-rounded table-head-bg-primary table-hover tb_displaytab" id="table-emp-contact" style="width: 100%">
                    <thead>
                        <tr>
                            <th>#</th>
