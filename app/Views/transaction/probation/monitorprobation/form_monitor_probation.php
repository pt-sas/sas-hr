    <div class="card-body card-form">
        <form class="form-horizontal form-absent" id="form_monitor_probation">
            <?= csrf_field(); ?>
            <!-- <div class="card"> -->
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="category">Bulan <span class="required">*</span></label>
                        ...
                        <small class="form-text text-danger" id="error_category"></small>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="submissiondate">Tanggal Monitoring <span class="required">*</span></label>
