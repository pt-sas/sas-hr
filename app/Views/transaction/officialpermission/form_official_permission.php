<div class="card-body card-form">
    <form class="form-horizontal form-absent" id="form_official_permission">
        <?= csrf_field(); ?>
        <div class="row">
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                <div class=" form-check mt-4">
                    <label class="form-radio-label">
                        <input class="form-radio-input" type="radio" id="submissiontype" name="submissiontype" value="izin resmi" checked disabled>
                        <span class="form-radio-sign">Izin Resmi</span>
                    </label>
                </div>
            </div>
            <div class="col-md-6">
