<div class="card-body card-form">
    <form class="form-horizontal form-absent" id="form_permission_leave_early">
        <?= csrf_field(); ?>
        <div class="row">
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                <div class=" form-check mt-4">
                    <label class="form-radio-label">
                        <input class="form-radio-input" type="radio" id="submissiontype" name="submissiontype"
                            value="pulang cepat" checked disabled>
                        <span class="form-radio-sign">Ijin Pulang Cepat</span>
                    </label>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <input type="text" class="form-control datetimepicker-start" name="startdate"
                                placeholder="Tanggal Mulai">
                        </div>
                        <div class="col-md-6">
                            <input type="text" class="form-control datetimepicker-end" name="enddate"
