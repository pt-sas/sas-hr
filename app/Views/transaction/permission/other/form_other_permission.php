<div class="card-body card-form">
    <form class="form-horizontal form-absent" id="form_other_permission.php">
        <?= csrf_field(); ?>
        <div class="row">
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control datetimepicker" id="submissiondate" name="submissiondate"
                ...
                <div class=" form-check mt-4">
                    <label class="form-radio-label">
                        <input class="form-radio-input" type="radio" id="submissiontype" name="submissiontype"
                            value="lain-lain" checked disabled>
                        <span class="form-radio-sign">Lain-Lain</span>
                    </label>
                </div>
            </div>
            <div class="col-md-6">
