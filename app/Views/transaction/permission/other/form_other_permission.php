        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control datetimepicker" id="submissiondate" name="submissiondate" value=<?= $today ?> readonly>
            ...
            <div class="col-md-3">
                <div class=" form-check mt-4">
                    <label class="form-radio-label">
                        <input class="form-radio-input" type="radio" id="submissiontype" name="submissiontype" value="lain-lain" checked disabled>
