...
<div class="modal fade" id="modal_assignment_realization_sup_agree_halfdayofficeduties">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Realisasi</h4>
            ...
            <div class="modal-body" id="realization">
                <form class="form-horizontal" id="form_assignment_realization_sup_agree_halfdayofficeduties">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="submissiondate">Tanggal <span class="required">*</span></label>
