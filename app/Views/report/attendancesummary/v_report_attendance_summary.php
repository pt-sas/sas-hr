...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <form action="<?= site_url('sas/laporan-rekap-kehadiran/showAllSummary') ?>" method="POST"
                    id="parameter_report">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6 col-md-9 col-sm-8 select2-input select2-primary">
                            <select class="form-control multiple-select-employee access"
                                name="md_employee_id[]"></select>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="periode" class="col-lg-3 col-md-3 col-sm-4 mt-sm-2 text-right">Periode </label>
                        <div class="col-lg-6 col-md-9 col-sm-8 select2-input select2-primary">
                            <input type="text" class="form-control datepicker-year" name="periode" value=<?= $month ?>
                                required></input>
                        </div>
                    </div>
