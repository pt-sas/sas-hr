            ...
            <div class="modal-body" id="activity_info">
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group table-responsive">
                            <table class="table table-bordered table-hover table_approval" style="width: 100%">
                                <thead>
                                    <tr>
                                        <th>#ID</th>
                                        <th>#Record ID</th>
                ...
                <form class="form-horizontal" id="form_activity_info">
                    <div class="form-group row">
                        ...
                        <!-- <div class="col-lg-2">
                            <button type="button" class="btn btn-icon btn-primary btn_record_info" data-toggle="tooltip"
                                data-placement="top" title="Record Info">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-2">
                            <button type="button" class="btn btn-icon btn-success btn_ok_answer" data-toggle="tooltip"
                                data-placement="top" title="OK">
