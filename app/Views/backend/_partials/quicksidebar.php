                        ...
                        <div class="quick-scroll scrollbar-outer">
                            <div class="quick-content contact-content">
                                ...
                                <div class="avatar-group">
                                    <div class="avatar">
                                        <img src="<?= base_url('custom/image/undraw_profile_1.svg') ?>" alt="..."
                                    ...
                                    <div class="user">
                                        <a href="#">
                                            <div class="avatar avatar-online">
                                                <img src="<?= base_url('custom/image/undraw_profile_1.svg') ?>"
                                    ...
                                    <div class="user">
                                        <a href="#">
                                            <div class="avatar avatar-offline">
                                                <img src="<?= base_url('custom/image/undraw_profile_2.svg') ?>"
                                                    alt="..." class="avatar-img rounded-circle border border-white">
                                            </div>
                                            <div class="user-data2">
                                    ...
                                    <div class="user">
                                        <a href="#">
                                            <div class="avatar avatar-away">
                                                <img src="<?= base_url('custom/image/undraw_profile_3.svg') ?>"
                                                    alt="..." class="avatar-img rounded-circle border border-white">
                                            </div>
                                            <div class="user-data2">
                    ...
                    <div class="messages-title">
                        <div class="user">
                            <div class="avatar avatar-offline float-right ml-2">
                                <img src="<?= base_url('custom/image/undraw_profile_3.svg') ?>" alt="..."
                                    class="avatar-img rounded-circle border border-white">
                            </div>
                            <span class="name">Chad</span>
                                ...
                                <li>
                                    ...
                                    <div class="item-control">
                                        <input type="checkbox" checked data-toggle="toggle" data-onstyle="primary"
                                            data-style="btn-round" data-size>
                                    </div>
                                </li>
                                <li>
