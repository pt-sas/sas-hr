...
class EmpFamily extends Entity
{
    protected $md_employee_family_id;
    ...
    public function getEmpFamilyId()
    {
        return $this->attributes['md_employee_family_id'];
    }

    public function setEmpFamilyId($md_employee_family_id)
    {
        $this->attributes['md_employee_family_id'] = $md_employee_family_id;
    }
