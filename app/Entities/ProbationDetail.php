...
class ProbationDetail extends Entity
{
    protected $trx_probation_detail_id;
    ...
    public function getProbationDetailId()
    {
        return $this->attributes['trx_probation_detail_id'];
    }

    public function setProbationDetailId($trx_probation_detail_id)
    {
        $this->attributes['trx_probation_detail_id'] = $trx_probation_detail_id;
    }
