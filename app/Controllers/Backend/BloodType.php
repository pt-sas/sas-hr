...
class BloodType extends BaseController
{
    public function __construct()
    {
        ...
        $this->model = new M_BloodType($this->request);
        $this->entity = new \App\Entities\BloodType();
    }

    public function index()
    {
        return $this->template->render('masterdata/bloodtype/v_bloodtype');
    }
    ...
    public function create()
    {
        if ($this->request->getMethod(true) === 'POST') {
            ...
            try {
                ...
                if (!$this->validation->run($post, 'bloodtype')) {
        ...
        if ($this->request->isAjax()) {
            ...
            try {
                ...
                foreach ($list as $key => $row) :
                    $response[$key]['id'] = $row->getBloodTypeId();
