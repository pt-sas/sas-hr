...
class Position extends BaseController
{
    public function __construct()
    {
        ...
        $this->model = new M_Position($this->request);
        $this->entity = new \App\Entities\Position();
    }

    public function index()
    {
        return $this->template->render('masterdata/position/v_position');
    }
    ...
    public function create()
    {
        if ($this->request->getMethod(true) === 'POST') {
            ...
            try {
                ...
                if (!$this->validation->run($post, 'position')) {
