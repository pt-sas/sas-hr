...
class Religion extends BaseController
{
    public function __construct()
    {
        ...
        $this->model = new M_Religion($this->request);
        $this->entity = new \App\Entities\Religion();
    }

    public function index()
    {
        return $this->template->render('masterdata/religion/v_religion');
    }
    ...
    public function create()
    {
        if ($this->request->getMethod(true) === 'POST') {
            ...
            try {
                ...
                if (!$this->validation->run($post, 'religion')) {
        ...
        if ($this->request->isAjax()) {
            ...
            try {
                ...
                foreach ($list as $key => $row) :
                    $response[$key]['id'] = $row->getReligionId();
