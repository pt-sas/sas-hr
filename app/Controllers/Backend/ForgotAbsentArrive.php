...
class ForgotAbsentArrive extends BaseController
{
    ...
    public function index()
    {
        ...
        return $this->template->render('transaction/forgetabsent/arrive/v_forgot_absent_arrive', $data);
    }
    ...
    public function showAll()
    {
        ...
        if ($this->request->getMethod(true) === 'POST') {
            ...
            $where['trx_absent.submissiontype'] = $this->model->Pengajuan_Lupa_Absen_Masuk;
    ...
    public function create()
    {
        ...
        if ($this->request->getMethod(true) === 'POST') {
            ...
            $post["submissiontype"] = $this->model->Pengajuan_Lupa_Absen_Masuk;
            $post["necessary"] = 'LM';
                        ...
                        if ($startDate > $subDate) {
                            ...
                            if ($trx) {
                                ...
                                if ($this->isNew()) {
                                    ...
                                    $docNo = $this->model->getInvNumber("submissiontype", $this->model->Pengajuan_Lupa_Absen_Masuk, $post, $this->session->get('sys_user_id'));
    ...
    public function exportPDF($id)
    {
        ...
        $pdf->Cell(0, 25, 'FORM LUPA ABSEN MASUK', 0, 1, 'C');
