...
class Skill extends BaseController
{
    public function __construct()
    {
        ...
        $this->model = new M_Skill($this->request);
        $this->entity = new \App\Entities\Skill();
    }

    public function index()
    {
        return $this->template->render('masterdata/skill/v_skill');
    }
    ...
    public function create()
    {
        if ($this->request->getMethod(true) === 'POST') {
            ...
            try {
                ...
                if (!$this->validation->run($post, 'skill')) {
        ...
        if ($this->request->isAjax()) {
            ...
            try {
                ...
                foreach ($list as $key => $row) :
                    $response[$key]['id'] = $row->getSkillId();
