...
class PermissionArrived extends BaseController
{
                        ...
                        if ($startDate > $subDate && (is_null($work) || is_null($trx))) {
                            ...
                            if ($endDate > $addDays) {
                                ...
                                if ($this->isNew()) {
                                    ...
                                    $docNo = $this->model->getInvNumber("submissiontype", $this->model->Pengajuan_Datang_Terlambat, $post, $this->session->get('sys_user_id'));
    ...
    public function exportPDF($id)
    {
        ...
        $pdf->Cell(0, 25, 'FORM DATANG TERLAMBAT', 0, 1, 'C');
