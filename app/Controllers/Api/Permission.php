...
class Permission extends ApiController
{
    ...
    public function index()
    {
        ...
        try {
            ...
            $service = new PermissionServices($this->jwt->sys_user_id, $this->jwt->md_employee_id);
            ...
            log_message('error', 'Permission [index] Error: ' . $e->getMessage() . ' | Line: ' . $e->getLine());
    ...
    public function create()
    {
        ...
        try {
            ...
            if (!$this->validation->run($data, 'absent')) {
            ...
            log_message('error', 'Permission [create] Error: ' . $e->getMessage() . ' | Line: ' . $e->getLine());
    ...
    public function show($id = null)
    {
        ...
        try {
            ...
            log_message('error', 'Permission [show] Error: ' . $e->getMessage() . ' | Line: ' . $e->getLine());
    ...
    public function proccessSubmission()
    {
        ...
        try {
            ...
            log_message('error', 'Permission [ProcessSubmission] Error: ' . $e->getMessage() . ' | Line: ' . $e->getLine());
