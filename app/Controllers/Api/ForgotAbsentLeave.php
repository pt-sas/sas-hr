...
use App\Services\ForgotAbsentLeaveServices;

class ForgotAbsentLeave extends ApiController
{
    protected $menuURL = 'lupa-absen-pulang';
    ...
    public function index()
    {
        ...
        try {
            ...
            $service = new ForgotAbsentLeaveServices($this->jwt->sys_user_id, $this->jwt->md_employee_id);
            ...
            log_message('error', 'ForgotAbsentLeave [index] Error: ' . $e->getMessage() . ' | Line: ' . $e->getLine());
    ...
    public function create()
    {
        ...
        try {
            ...
            log_message('error', 'ForgotAbsentLeave [create] Error: ' . $e->getMessage() . ' | Line: ' . $e->getLine());
    ...
    public function show($id = null)
    {
        ...
        try {
            ...
            log_message('error', 'ForgotAbsentLeave [show] Error: ' . $e->getMessage() . ' | Line: ' . $e->getLine());
    ...
    public function proccessSubmission()
    {
        ...
        try {
            ...
            log_message('error', 'ForgotAbsentLeave [ProcessSubmission] Error: ' . $e->getMessage() . ' | Line: ' . $e->getLine());
