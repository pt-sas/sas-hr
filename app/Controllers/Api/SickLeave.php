...
class SickLeave extends ApiController
{
    protected $menuURL = 'sakit';
    ...
    public function index()
    {
        ...
        try {
            ...
            $service = new SickLeaveServices($this->jwt->sys_user_id, $this->jwt->md_employee_id);
            ...
            log_message('error', 'SickLeave [index] Error: ' . $e->getMessage() . ' | Line: ' . $e->getLine());
    ...
    public function create()
    {
        ...
        try {
            ...
            if (!$this->validation->run($data, 'sakit')) {
            ...
            log_message('error', 'SickLeave [create] Error: ' . $e->getMessage() . ' | Line: ' . $e->getLine());
    ...
    public function show($id = null)
    {
        ...
        try {
            ...
            log_message('error', 'SickLeave [show] Error: ' . $e->getMessage() . ' | Line: ' . $e->getLine());
    ...
    public function proccessSubmission()
    {
        ...
        try {
            ...
            log_message('error', 'SickLeave [ProcessSubmission] Error: ' . $e->getMessage() . ' | Line: ' . $e->getLine());
